...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;Waffentabelle&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-227659416-even" margin-left="0.79in" margin-right="0.79in" page-height="8.27in" page-width="11.69in" margin-top="0.30in" margin-bottom="0.30in">
			...
			<fo:simple-page-master master-name="page-master-227659416-odd" margin-left="0.79in" margin-right="0.79in" page-height="8.27in" page-width="11.69in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="0.30in" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
			...
			<fo:page-sequence-master master-name="page-master-227659416">
				<fo:repeatable-page-master-alternatives>
					<fo:conditional-page-master-reference master-reference="page-master-227659416-even" odd-or-even="even"/>
					<fo:conditional-page-master-reference master-reference="page-master-227659416-odd" odd-or-even="odd"/>
				</fo:repeatable-page-master-alternatives>
	...
	<xsl:variable name="altova:design-xslt-tree-view">
		<altova:main-document url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.fo') else ''}">
			<fo:root>
				...
				<fo:page-sequence master-reference="page-master-227659416" initial-page-number="auto" format="1" force-page-count="no-force">
												...
												<fo:table-cell font-size="10pt" padding="0" display-align="center">
													<fo:block text-align="left">
														<fo:inline font-weight="bold">
															<xsl:text>Waffenabgang im Monat: </xsl:text>
														</fo:inline>
								...
								<fo:table font-family="Courier" text-align="center" table-layout="fixed" width="100%" border-spacing="2pt">
									...
									<fo:table-header background-color="#d2d2d2" font-size="5pt" font-weight="bold" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" start-indent="0pt">
										<fo:table-row height="auto">
											...
											<fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-left-style="solid" border-left-width="thin" border-top-style="none" border-top-width="thin" padding-bottom="0.01in" padding-left="0.02in" padding-right="0.02in" padding-top="0.01in" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
												<fo:block text-align="center">
											...
											<fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-left-style="solid" border-left-width="thin" border-top-style="none" border-top-width="thin" padding-bottom="0.01in" padding-left="0.02in" padding-right="0.02in" padding-top="0.01in" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
												<fo:block text-align="center">
													<fo:inline>
														<xsl:text>Überlasser-adresse</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-left-style="solid" border-left-width="thin" border-top-style="none" border-top-width="thin" padding-bottom="0.01in" padding-left="0.02in" padding-right="0.02in" padding-top="0.01in" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
											...
											<fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-left-style="solid" border-left-width="thin" border-top-style="none" border-top-width="thin" padding-bottom="0.01in" padding-left="0.02in" padding-right="0.02in" padding-top="0.01in" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
												<fo:block text-align="center">
													<fo:inline>
														<xsl:text>Empfänger-adresse</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-bottom-style="solid" border-bottom-width="thin" border-left-style="solid" border-left-width="thin" border-top-style="none" border-top-width="thin" padding-bottom="0.01in" padding-left="0.02in" padding-right="0.02in" padding-top="0.01in" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
											...
											<xsl:for-each select="waffen">
												<xsl:for-each select="waffe">
													<fo:table-row font-size="7pt" text-align="center" background-color="{if ( position() mod 2 = 0 ) then &quot;white&quot; else &quot;#e1e1e1&quot;}">
														<fo:table-cell border-right-color="#969696" border-right-style="dotted" border-right-width="thin" font-size="5pt" keep-together.within-page="always" keep-together.within-column="always" table-omit-header-at-break="true" padding="2pt" display-align="center">
															<fo:block text-align="center">
														...
														<fo:table-cell border-right-color="#969696" border-right-style="dotted" border-right-width="thin" font-size="5pt" padding="2pt" display-align="center">
															<fo:block text-align="left">
														...
														<fo:table-cell font-size="5pt" keep-together.within-page="always" keep-together.within-column="always" table-omit-header-at-break="true" padding="2pt" display-align="center">
															<fo:block text-align="center">
	...
	<xsl:template name="Vorlage1">
		<altova:inline-container-substitute font-size="5pt" text-align="center">
