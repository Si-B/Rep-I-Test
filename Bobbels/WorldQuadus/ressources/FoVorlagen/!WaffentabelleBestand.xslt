...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			...
			<fo:simple-page-master master-name="page-master-156037968-even" margin-left="0.79in" margin-right="0.79in" page-height="8.27in" page-width="11.69in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.1cm" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" extent="1cm"/>
			</fo:simple-page-master>
			
			<fo:simple-page-master master-name="page-master-156037968-odd" margin-left="0.79in" margin-right="0.79in" page-height="8.27in" page-width="11.69in" margin-top="0.30in" margin-bottom="0.30in">
				<fo:region-body margin-top="1.1cm" margin-bottom="0.30in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" extent="1cm"/>
			</fo:simple-page-master>
			
			
			<fo:page-sequence-master master-name="page-master-156037968">
				<fo:repeatable-page-master-alternatives>
					<fo:conditional-page-master-reference master-reference="page-master-156037968-even" odd-or-even="even"/>
					<fo:conditional-page-master-reference master-reference="page-master-156037968-odd" odd-or-even="odd"/>
				</fo:repeatable-page-master-alternatives>
	...
	<xsl:variable name="altova:design-xslt-tree-view">
		<altova:main-document url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.fo') else ''}">
			<fo:root>
				...
				<fo:page-sequence master-reference="page-master-156037968" initial-page-number="auto" format="1" force-page-count="no-force">
												...
												<fo:table-cell font-size="10pt" padding="0" display-align="center">
													<fo:block text-align="left">
														<fo:inline font-weight="bold">
															<xsl:text>Titel: dghfhfghfhfhf</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell font-size="10pt" padding="0" display-align="center">
						...
						<fo:block font-family="Cordia New">
							<xsl:variable name="altova:table">
								<fo:table table-layout="fixed" width="100%" border-spacing="0">
									...
									<fo:table-header background-color="#d2d2d2" start-indent="0pt">
										<fo:table-row font-size="smaller" margin-bottom="5" margin-left="5" margin-right="5" margin-top="5" text-align="left">
											<fo:table-cell border-style="solid" border-width="thin" font-family="Courier New" font-size="8pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="2" margin-left="1" margin-right="1" margin-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
												<fo:block text-align="center">
											...
											<fo:table-cell border-style="solid" border-width="thin" font-family="Courier New" font-size="8pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="2" margin-left="1" margin-right="1" margin-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
												<fo:block text-align="center">
													<fo:inline text-align="center">
														<xsl:text>Seriennummer 1</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-style="solid" border-width="thin" font-family="Courier New" font-size="8pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="2" margin-left="1" margin-right="1" margin-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
												<fo:block text-align="center">
													<fo:inline text-align="center">
														<xsl:text>Waffentyp-feingliederung</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-style="solid" border-width="thin" font-family="Courier New" font-size="8pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="2" margin-left="1" margin-right="1" margin-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
											...
											<fo:table-cell border-style="solid" border-width="thin" font-family="Courier New" font-size="8pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="2" margin-left="1" margin-right="1" margin-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
												<fo:block text-align="center">
													<fo:inline text-align="center">
														<xsl:text>Nachweis-nummer</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border-style="solid" border-width="thin" font-family="Courier New" font-size="8pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="2" margin-left="1" margin-right="1" margin-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
											...
											<fo:table-cell border-style="solid" border-width="thin" font-family="Courier New" font-size="8pt" keep-together.within-page="always" keep-together.within-column="always" margin-bottom="2" margin-left="1" margin-right="1" margin-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
												<fo:block text-align="center">
													<fo:inline text-align="center">
														<xsl:text>Nachweis-behörde</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
										...
										<xsl:for-each select="$XML">
											<xsl:for-each select="waffen">
												<xsl:for-each select="waffe">
													<fo:table-row border-style="solid" font-size="7pt" text-align="center">
														<fo:table-cell border-right-color="#969696" border-right-style="dotted" border-right-width="thin" font-family="Courier New" font-size="7pt" keep-together.within-page="always" keep-together.within-column="always" padding-bottom="2" padding-left="2" padding-right="2" padding-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
															<fo:block text-align="center">
														...
														<fo:table-cell border-style="solid" border-width="thin" font-family="Courier New" font-size="7pt" keep-together.within-page="always" keep-together.within-column="always" padding-bottom="2" padding-left="2" padding-right="2" padding-top="2" table-omit-header-at-break="true" padding="0" display-align="center">
															<fo:block text-align="center">
