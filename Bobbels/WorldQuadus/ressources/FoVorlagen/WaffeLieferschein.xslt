...
<!--Erstellt und generiert von Altova StyleVision Enterprise Edition 2012 sp1 - nähere Informationen siehe http://www.altova.com/de/stylevision-->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;WaffeLieferschein&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:decimal-format name="format1" grouping-separator="." decimal-separator=","/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-144672592-even" margin-left="1.52cm" margin-right="1.52cm" page-height="29.70cm" page-width="21cm" margin-top="0.76cm" margin-bottom="0.76cm">
				<fo:region-body margin-top="1.25cm" margin-bottom="1.25cm" column-count="1" column-gap="1cm"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="1.25cm"/>
				<fo:region-after region-name="even-page-footer" overflow="hidden" extent="1.25cm"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-144672592-odd" margin-left="1.52cm" margin-right="1.52cm" page-height="29.70cm" page-width="21cm" margin-top="0.76cm" margin-bottom="0.76cm">
				<fo:region-body margin-top="1.25cm" margin-bottom="1.25cm" column-count="1" column-gap="1cm"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="1.25cm"/>
				<fo:region-after region-name="odd-page-footer" overflow="hidden" extent="1.25cm"/>
			</fo:simple-page-master>
			<fo:page-sequence-master master-name="page-master-144672592">
				<fo:repeatable-page-master-alternatives>
					<fo:conditional-page-master-reference master-reference="page-master-144672592-even" odd-or-even="even"/>
					<fo:conditional-page-master-reference master-reference="page-master-144672592-odd" odd-or-even="odd"/>
				</fo:repeatable-page-master-alternatives>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:xmp="http://ns.adobe.com/xap/1.0/">
								<xmp:CreatorTool>Altova StyleVision Enterprise Edition 2012 sp1 (http://www.altova.com)</xmp:CreatorTool>
							</rdf:Description>
						</rdf:RDF>
					</x:xmpmeta>
				</fo:declarations>
				<fo:page-sequence master-reference="page-master-144672592" initial-page-number="auto" format="1" force-page-count="no-force">
					<fo:static-content flow-name="odd-page-header">
						<fo:block-container overflow="hidden" display-align="before">
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table font-family="Courier" font-weight="bold" width="100%" table-layout="fixed" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell font-size="11pt" padding="0" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
															<xsl:text>Waffe: </xsl:text>
														</fo:inline>
												...
												<fo:table-cell font-size="11pt" padding="0" display-align="center">
													<fo:block text-align="right">
														<xsl:value-of select="format-number(number(substring(string(current-date()), 9, 2)), '00', 'format1')"/>
														<xsl:variable name="sText" as="xs:string?">
															<xsl:text>. </xsl:text>
														</xsl:variable>
														<xsl:value-of select="$sText"/>
														<xsl:value-of select="format-number(number(substring(string(current-date()), 6, 2)), '00', 'format1')"/>
														<xsl:variable name="sText" as="xs:string?">
															<xsl:text>. </xsl:text>
														</xsl:variable>
														<xsl:value-of select="$sText"/>
														<xsl:value-of select="format-number(number(substring(string(string(current-date())), 1, 4)), '0000', 'format1')"/>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
											<fo:table-row>
							...
							<fo:block>
								<xsl:variable name="altova:table">
									<fo:table width="100%" table-layout="fixed" border-spacing="2pt">
										...
										<fo:table-body start-indent="0pt">
											<fo:table-row>
												<fo:table-cell number-columns-spanned="2" font-family="Courier" padding="0" display-align="center">
													<fo:block text-align="left">
														<fo:block text-align="center">
															<fo:leader leader-pattern="rule" rule-thickness="1" leader-length="100%" color="black"/>
														</fo:block>
											...
											<fo:table-row>
												<fo:table-cell font-family="Courier" font-size="10pt" padding="0" display-align="center">
													<fo:block text-align="left">
														<fo:inline>
					...
					<fo:flow flow-name="xsl-region-body">
						<fo:block table-layout="fixed">
							<xsl:variable name="altova:table">
								<fo:table font-family="Courier" table-layout="fixed" width="100%" border-spacing="1">
									<fo:table-column column-width="7.430cm"/>
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell font-weight="bold" padding="1" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
										...
										<fo:table-row>
											<fo:table-cell font-weight="bold" padding="1" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
														<xsl:text>Empfängeradresse</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="1" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="waffen">
															<xsl:for-each select="waffe">
																<xsl:for-each select="empfaengerAdresse">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
										...
										<fo:table-row>
											<fo:table-cell font-weight="bold" padding="1" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
														<xsl:text>Waffentypfeingliederung</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="1" display-align="center">
										...
										<fo:table-row height="0.42cm">
											<fo:table-cell font-weight="bold" padding="1" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
														<xsl:text>Abgang</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="1" display-align="center">
										...
										<fo:table-row>
											<fo:table-cell font-weight="bold" padding="1" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
														<xsl:text>Nachweisnummer</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="1" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="waffen">
															<xsl:for-each select="waffe">
																<xsl:for-each select="nachweisNummer">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
										...
										<fo:table-row>
											<fo:table-cell font-weight="bold" padding="1" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
														<xsl:text>Nachweisdatum</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="1" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="waffen">
															<xsl:for-each select="waffe">
																<xsl:for-each select="nachweisDatum">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
										...
										<fo:table-row height="0.42cm">
											<fo:table-cell font-weight="bold" padding="1" display-align="center">
												<fo:block text-align="left">
													<fo:inline>
														<xsl:text>Nachweisbehörde</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell padding="1" display-align="center">
												<fo:block text-align="left">
													<xsl:for-each select="$XML">
														<xsl:for-each select="waffen">
															<xsl:for-each select="waffe">
																<xsl:for-each select="nachweisBehoerde">
																	<altova:inline-container-substitute>
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
