		...
		<children>
			<globaltemplate subtype="main" match="/">
				...
				<children>
													...
													<tgridrow>
														<children>
															<tgridcell>
																...
																<children>
																	<text fixtext="Waffenbestand zum 1. ">
																	...
																	<template subtype="source" match="XML">
																		<children>
																			<template subtype="element" match="waffen">
																				<children>
																					<template subtype="attribute" match="datum">
																						<children>
					...
					<tgrid>
						<properties border="0" dataformatas="plaintext"/>
						<styles font-family="Courier" max-height="inherit" text-align="center"/>
						<children>
							<tgridbody-cols>
								<children>
									<tgridcol>
							...
							<tgridheader-rows>
								...
								<children>
									<tgridrow>
										...
										<children>
											<tgridcell>
												<styles border-bottom-style="solid" border-bottom-width="thin" font-size="8pt" padding-bottom="1px" padding-left="2px" padding-right="2px" padding-top="1px" text-align="center" white-space="pre-wrap"/>
												<children>
											...
											<tgridcell>
												<styles border-bottom-style="solid" border-bottom-width="thin" border-left-style="solid" border-left-width="thin" border-top-style="none" border-top-width="thin" font-size="8pt" padding-bottom="1px" padding-left="2px" padding-right="2px" padding-top="1px" text-align="center" white-space="pre-wrap"/>
												<children>
											...
											<tgridcell>
												<styles border-bottom-style="solid" border-bottom-width="thin" border-left-style="solid" border-left-width="thin" border-top-style="none" border-top-width="thin" font-size="8pt" padding-bottom="1px" padding-left="2px" padding-right="2px" padding-top="1px" text-align="center" white-space="pre-wrap"/>
												<children>
													<text fixtext="Überlasseradresse"/>
												</children>
											</tgridcell>
										</children>
									</tgridrow>
													...
													<template subtype="element" match="waffe">
														<children>
															<tgridrow>
																...
																<children>
																	<tgridcell>
																		<styles border-right-color="#969696" border-right-style="dotted" border-right-width="thin" font-size="7pt" keep-together="always" table-omit-header-at-break="true" text-align="center"/>
																		<children>
																	...
																	<tgridcell>
																		...
																		<children>
																			<template subtype="element" match="waffentypFeingliederung">
																				<children>
																					<calltemplate subtype="named" match="Vorlage1">
																						<parameters/>
																					</calltemplate>
																				</children>
																				<variables/>
																	...
																	<tgridcell>
																		<styles border-right-color="#969696" border-right-style="dotted" border-right-width="thin" font-size="7pt"/>
																		<children>
